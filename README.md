...
jobs:
  build_and_push_to_ecr:
    ...
    uses: peldanotech/workflows/.github/workflows/ecr.yml@v3.2.0
    with:
...
jobs:
  deploy_to_aws:
    ...
    uses: peldanotech/workflows/.github/workflows/docker.yml@v3.2.0
    with:
      aws-region: us-west-2
...
jobs:
  deploy_image_to_eks:
    ...
    uses: peldanotech/workflows/.github/workflows/eks.yml@v3.2.0
    with:
      aws-region: us-west-2
...
jobs:
  build_and_push_to_s3:
    ...
    uses: peldanotech/workflows/.github/workflows/s3.yml@v3.2.0
    with:
      aws-region: us-west-2
      s3-bucket-name: bucket-name
...
jobs:
  sonarqube_scan:
    name: SonarQube scan
    uses: peldanotech/workflows/.github/workflows/sonar.yml@v3.2.0
    with:
      node-version: 18.x (optional)
    secrets: inherit
```
...
jobs:
  deploy_image_to_ecs:
    ...
    uses: peldanotech/workflows/.github/workflows/ecs.yml@v3.2.0
    with:
      aws-region: us-west-2
...
jobs:
  build_and_deploy_to_aws:
    ...
    uses: peldanotech/workflows/.github/workflows/deploy.yml@v3.2.0
    with:
      aws-region: us-west-2
      s3-bucket-name: bucket-name
      application-name: ec2-on-premises (optional)
